...
.banner-box:nth-child(1) {
  background-image: url(<?php echo e(asset('images/b3.jpg')); ?>);
}
.banner-box h4{
  color:#000;
  font-size:30px;
...
.banner-box:nth-child(2){
  background-image:url(<?php echo e(asset('images/b4.jpg')); ?>); 
 
 
}
.banner-box:nth-child(3){
  background-image:url(<?php echo e(asset('images/b2.jpg')); ?>); 
...
<?php echo $__env->make('shoppingPageLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\SCHOOL\project1.9\resources\views/shoppingHomePage.blade.php ENDPATH**/ ?>